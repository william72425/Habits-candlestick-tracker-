      ...
      if (cachedConfig) {
        try {
          ...
          setConfig({
            ...
            ...parsed,
            predictions: parsed.predictions ?? DEFAULT_TERMINAL_CONFIG.predictions,
            pointsHistory: parsed.pointsHistory ?? DEFAULT_TERMINAL_CONFIG.pointsHistory,
            totalPoints: parsed.totalPoints ?? DEFAULT_TERMINAL_CONFIG.totalPoints,
            timezone: parsed.timezone ?? DEFAULT_TERMINAL_CONFIG.timezone,
            timezoneOffset: parsed.timezoneOffset ?? DEFAULT_TERMINAL_CONFIG.timezoneOffset,
            nightOwlOffset: parsed.nightOwlOffset ?? DEFAULT_TERMINAL_CONFIG.nightOwlOffset,
            lastActiveDate: parsed.lastActiveDate ?? DEFAULT_TERMINAL_CONFIG.lastActiveDate,
            consecutiveAfkCount: parsed.consecutiveAfkCount ?? DEFAULT_TERMINAL_CONFIG.consecutiveAfkCount,
            afkHistory: parsed.afkHistory ?? DEFAULT_TERMINAL_CONFIG.afkHistory,
          });
        } catch (e) {
